    ...
    <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
        ...
        <div class="flex items-center justify-between">
            ...
            <div class="lg:ml-40 ml-10 space-x-8">
                    ...
                    @if($isOpen)
                        @include('livewire.fixture_create')
                    @endif
            </div>
        </div>
            ...
            <table class="w-full divide-y divide-gray-200 table-auto">
              <thead class="bg-indigo-500 text-white">
                <tr class="text-left text-xs font-bold  uppercase">
                  ...
                  <td scope="col" class="px-6 py-3">Equipo 1</td>
                  <td scope="col" class="px-6 py-3">Equipo 2</td>
                  <td scope="col" class="px-6 py-3">Fecha y hora</td>
                  <td scope="col" class="px-6 py-3">GE1</td>
                  <td scope="col" class="px-6 py-3">GE2</td>
                  <td scope="col" class="px-6 py-3">Estado</td>
                  <td scope="col" class="px-6 py-3">Ganador</td>
              ...
              <?php foreach ($games as $item): ?>
                <tr class="text-sm font-medium text-gray-900">
                  ...
                  <td class="px-6 py-4">{{$item->winner}}</td>
                  <td class="px-6 py-4">
            ...
            Swal.fire({
              ...
              confirmButtonText: 'Yes, delete it!'
                ...
                if (result.isConfirmed) {
                    //alert("del");
                    Livewire.emitTo('crud-fixture','delete',id);
                    Swal.fire(
                        'Deleted!',
